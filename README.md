...
![Base de Datos para Negocios Digitales](./img/Gemini.png "BD.")
...
docker run --name mysqlev -p 3341:3306 -v vol-mysqlev:/var/lib/mysql -e MYSQL_ROOT_PASSWORD=12346 -d mysql